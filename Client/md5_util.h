/**
 * @file md5_util.h
 * @brief Встроенная реализация хэш-функции MD5 (public domain).
 */
...
/**
 * @namespace md5_impl
 * @brief Внутренние детали реализации MD5. Не использовать напрямую — используйте md5().
 */
namespace md5_impl {
...
/**
 * @brief Выполняет один раунд MD5 над 64-байтным блоком данных.
 * @param state Текущее состояние (4×32 бит).
 * @param block Входной блок данных размером 64 байта.
 */
...
/**
 * @brief Вычисляет MD5-хэш строки и возвращает его как hex-строку нижнего регистра.
 * @param input Входная строка.
 * @return 32-символьная hex-строка MD5-дайджеста.
 */
