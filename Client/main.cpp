...
void initTranslations() {
    ...
    tr_en["regSuccess"]="Registration successful! Now log in."; tr_ru["regSuccess"]="Регистрация успешна! Теперь войдите.";
    tr_en["userExists"]="User already exists!"; tr_ru["userExists"]="Пользователь уже существует!";
    // ЭМОДЗИ ВСТРОЕНЫ ПРЯМО В ПЕРЕВОД
    ...
    tr_en["exit"]="Exit"; tr_ru["exit"]="Выход";
    tr_en["check"]="Check"; tr_ru["check"]="Проверить";
    tr_en["correct"]="Correct!"; tr_ru["correct"]="Правильно!";
    tr_en["wrong"]="Wrong."; tr_ru["wrong"]="Неправильно.";
...
QString darkStyle() {
    return R"(
        * { font-family: "Segoe UI", "Arial", sans-serif; font-size: 13px; }
        ...
        QPushButton#btnBack:hover, QPushButton#btnToReg:hover, QPushButton#btnLang:hover { background-color: #30363d; }
        QPushButton#btnLogout { background-color: #da3633; border-color: #f85149; color: white; }
        QPushButton#btnLogout:hover { background-color: #f85149; }
        ...
        QSlider::handle:horizontal:hover { background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #a5d6ff, stop:1 #79c0ff); }
...
QString lightStyle() {
    return R"(
        * { font-family: "Segoe UI", "Arial", sans-serif; font-size: 13px; }
        ...
        QPushButton#btnBack:hover, QPushButton#btnToReg:hover, QPushButton#btnLang:hover { background-color: #eaeef2; }
        QPushButton#btnLogout { background-color: #cf222e; border-color: #cf222e; color: white; }
        QPushButton#btnLogout:hover { background-color: #a40e26; }
        ...
        QSlider::handle:horizontal:hover { background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #a5d6ff, stop:1 #0550ae); }
